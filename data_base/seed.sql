...
INSERT INTO docente (nome_docente, email)VALUES
('Aécio', 'aecio@senac.com.br'),
('Luana', 'luana@senac.com.br');

INSERT INTO informacoes_curso(nome_curso, sigla_curso, codigo_turma, oferta, periodo, sub_area_id, docente_id) VALUES 
('TÉCNICO EM INFORMÁTICA PARA INTERNET','TII05', 'TECNICO', '0000005', 'noite', 5, 2);
